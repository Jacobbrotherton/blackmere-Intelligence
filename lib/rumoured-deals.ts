...
export const rumouredDeals: RumouredDeal[] = [
  {
    ...
    summary: "Paramount Group — the David Ellison-led entity following Skydance's takeover — launched an unsolicited $110.9 billion tender offer for Warner Bros. Discovery in December 2025 at $31 per share. WBD's board declared the offer superior to Netflix's prior $82.7B bid on February 26, 2026, with Netflix collecting a $2.8 billion break-up fee. A definitive merger agreement has since been signed, creating the world's largest entertainment conglomerate uniting Paramount Pictures, CBS, HBO, CNN, and Max. David Ellison will serve as Chairman and CEO. The deal carries a $7 billion regulatory termination fee — one of the largest in corporate history — reflecting genuine antitrust exposure from the combined group's dominance across scripted content, theatrical distribution, and free-to-air broadcasting. DOJ and FCC clearances are pending, with close targeted for Q3 2026.",
  ...
  },
  {
    ...
    summary: "Charter Communications is acquiring Cox Enterprises' cable, commercial fiber, and cloud communications businesses for $34.5 billion — the largest US cable consolidation since Charter's own Time Warner Cable acquisition in 2016. Cox Communications, the third-largest US cable operator with approximately 7 million subscribers, has been a privately held subsidiary since its founding. The combined company will have 38 million subscribers. The FCC approved the deal in February 2026 with conditions including US job preservation and rural broadband investment commitments. California remains the outstanding regulatory hurdle; Charter has formally requested the California PUC to accelerate its review ahead of a September 15, 2026 federal merger condition deadline. Full close is expected before September 2026 subject to California approval.",
    source: "Deadline / FCC",
    dateRumoured: "2025-05",
    status: "Talks Confirmed",
    sector: "Telecommunications / Cable",
    dealProbability: 78,
    probabilityRationale: "FCC approved February 2026; California PUC approval the only remaining hurdle before the September 2026 deadline.",
    keyStats: {
