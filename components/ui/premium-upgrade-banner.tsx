...
export function PremiumUpgradeBanner() {
  ...
  return (
    <section className="bg-[#030303] py-16 px-4 md:px-8">
      <div className="max-w-6xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row gap-12 items-start">
              ...
              <div className="flex-1">
                ...
                <h2 className="text-4xl md:text-5xl font-bold text-white mb-4 leading-tight">
                  ...
                  <span className="text-white/60">Consumer price.</span>
                </h2>

                <p className="text-white/40 text-lg leading-relaxed mb-8 max-w-lg">
                  Bloomberg charges £24,000/year. Blackmere Intelligence gives you
                  AI-powered M&A deal intelligence for less than the price of a coffee
                  per week.
                </p>
        ...
        >
          ...
          <span>🇬🇧 Built for UK &amp; Global Markets</span>
        </motion.div>
      </div>
    </section>
  );
