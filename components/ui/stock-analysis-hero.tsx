        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <motion.div custom={2} variants={fadeUpVariants} initial="hidden" animate="visible">
            <p className="text-base sm:text-lg md:text-xl text-white/40 mb-8 leading-relaxed font-light tracking-wide max-w-xl mx-auto px-4">
              Position yourself ahead of the market — track live intelligence on
              rumoured mergers, potential buyouts and emerging private equity plays
              before they make the headlines.
            </p>
          </motion.div>

          <motion.div custom={3} variants={fadeUpVariants} initial="hidden" animate="visible">
            <p className="text-sm text-white/20 tracking-widest uppercase">
              Scroll to explore rumoured deals
            </p>
            <motion.div
              animate={{ y: [0, 8, 0] }}
